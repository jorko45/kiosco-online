...
-- El barrendero: cierra vencidas y vuelve a ofrecer. Lo llama la consola
-- cada pocos segundos, asi no hace falta un cron.
...
begin
  ...
  loop
    perform ofrecer_pedido(r.pedido_id);
    n := n + 1;
  end loop;
  return n;
end $$;
